...
var data = [
 ...
 data.push({name:utcDate,Dust: 20}) ;


 
 
export default class DustChart extends React.Component {	
    //static jsfiddleUrl = 'https://jsfiddle.net/alidingling/xqjtetw0/';
    constructor(props){
        super(props);
        
      //  data.push({name:utcDate,Dust: this.props.val}) ;
    ...
    render() {
      //var m={name:utcDate,Dust: this.props.val};
    ...
    <YAxis dataKey='Dust' tick={{fill:'black',fontSize:10}}/>
    <Tooltip wrapperStyle={{fontSize:10}} />
    <Legend wrapperStyle={{fontSize:16}}/>
    <Line type="monotone" dataKey="Dust"  isUpdateAnimationActive={true} stroke="#82ca9d"/>
